class Game {
  ...
  String[] rawData = loadStrings("levels/level1.txt");

  Game(String path) {
    _board = new Board(rawData);
  ...
  Game(String path, Board board, Hero hero, Blinky blinky, Inky inky, Pinky pinky, Clyde clyde, String gameState, float timeNoPause) {
    _board = board;
    _hero = hero;
    _blinky = blinky;
    _clyde = clyde;
